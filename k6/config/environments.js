...
const ENVIRONMENTS = {
    ...
    staging: {
        baseURL: __ENV.STAGING_URL || 'http://13.229.28.101:8082',
        apiPrefix: '/api/v1',
        users: {
    ...
    production: {
        baseURL: __ENV.PROD_URL || 'http://13.229.28.101:8080',
        apiPrefix: '/api/v1',
        users: {
...
export const env = {
    ...(ENVIRONMENTS[ENV_NAME] || ENVIRONMENTS.local),
};

env.baseURL = normalizeBaseURL(env.baseURL);
