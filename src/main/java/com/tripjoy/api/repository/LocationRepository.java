...
public interface LocationRepository extends JpaRepository<Location, UUID> {
    ...
    List<Location> findVerifiedByTypeAndCountry(
            @Param("type") LocationType type, @Param("countryCode") String countryCode);
    ...
    Page<Location> findVerifiedByTypeWithCountry(
            @Param("type") LocationType type, @Param("countryCode") String countryCode, Pageable pageable);
    ...
    boolean existsByAdminCodeAndCountryCode(
            @Param("adminCode") String adminCode, @Param("countryCode") String countryCode);
}
