...
public class MediaUploadResponse {
    ...
    @Schema(description = "HTTP URL of the uploaded media", example = "http://res.cloudinary.com/tripjoy/image/upload/v1614770203/tripjoy/avatars/users/img.jpg")
    String url;

    @JsonProperty("secure_url")
    @Schema(description = "HTTPS URL of the uploaded media (use this in production)", example = "https://res.cloudinary.com/tripjoy/image/upload/v1614770203/tripjoy/avatars/users/img.jpg")
    String secureUrl;

    @JsonProperty("public_id")
    @Schema(description = "Cloudinary public ID, used for deletion or further transformations", example = "tripjoy/avatars/users/abc123")
    String publicId;
